...
%
% ConfigurationName :
% "Phase1" - for KPP verification, magnets in Phase 1 config
% "Phase2" - for KPP verification, magnets in Phase 2 config
...
if ConfigName=="phase1"
  qind=1:4;
  lval=[-20.3 -21.3 -24.6 -44.1]; uval=[20.3 21.3 24.6 44.1];
  qm={'QFF1*' 'QFF2*' 'QFF4*' 'QFF6*'};
elseif ConfigName=="phase2"
  lval=[-20.3 -21.3 -44.1 -44.1 -44.1]; uval=[20.3 21.3 44.1 44.1 44.1];
